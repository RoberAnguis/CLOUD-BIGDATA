...
o = sys.argv[2]
# cargamos los datos
dfMax = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Tmax4.csv")
dfMin = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Tmin4.csv")
dfPre = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Preci4.csv")
dfAmp = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/AmpT4.csv")
...
df_res.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tavg4.csv") # guardamos en csv
...
df_res1.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/CambTemp4.csv") # guardamos en csv
...
df_res2.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Desv4_results.csv") # guardamos en csv
...
df_res3.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tmax4_result.csv") # guardamos en csv
...
df_res4.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tmin4_results.csv") # guardamos en csv


# Amplitud Termica ------------------------------------------------------------------------------------------------------------------------------------------------------


dfAmp2 = dfAmp.groupBy("Año", "Mes").agg({'Día 1':'avg', 'Día 2':'avg', 'Día 3':'avg', 'Día 4':'avg', 'Día 5':'avg', 'Día 6':'avg', 'Día 7':'avg', 'Día 8':'avg', 'Día 9':'avg', 'Día 10':'avg', 'Día 11':'avg', 'Día 12':'avg', 'Día 13':'avg', 'Día 14':'avg', 'Día 15':'avg', 'Día 16':'avg', 'Día 17':'avg', 'Día 18':'avg', 'Día 19':'avg', 'Día 20':'avg', 'Día 21':'avg', 'Día 22':'avg', 'Día 23':'avg', 'Día 24':'avg', 'Día 25':'avg', 'Día 26':'avg', 'Día 27':'avg', 'Día 28':'avg', 'Día 29':'avg', 'Día 30':'avg', 'Día 31':'avg'}).sort("Año", "Mes")
dfAmp3 = dfAmp2.groupBy("Año").agg({'avg(Día 1)':'max', 'avg(Día 2)':'max', 'avg(Día 3)':'max', 'avg(Día 4)':'max', 'avg(Día 5)':'max', 'avg(Día 6)':'max', 'avg(Día 7)':'max', 'avg(Día 8)':'max', 'avg(Día 9)':'max', 'avg(Día 10)':'max', 'avg(Día 11)':'max', 'avg(Día 12)':'max', 'avg(Día 13)':'max', 'avg(Día 14)':'max', 'avg(Día 15)':'max', 'avg(Día 16)':'max', 'avg(Día 17)':'max', 'avg(Día 18)':'max', 'avg(Día 19)':'max', 'avg(Día 20)':'max', 'avg(Día 21)':'max', 'avg(Día 22)':'max', 'avg(Día 23)':'max', 'avg(Día 24)':'max', 'avg(Día 25)':'max', 'avg(Día 26)':'max', 'avg(Día 27)':'max', 'avg(Día 28)':'max', 'avg(Día 29)':'max', 'avg(Día 30)':'max', 'avg(Día 31)':'max'}).sort('Año')
...
result = dfAmp3.rdd.map(amplitude)
dfResult = spark.createDataFrame(result, ["Año", "Maxima Amplitud"])
dfResult.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/AmpTerm4.csv") # guardamos en csv
...
df_fin.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/DiasLluvia4.csv") # guardamos en csv
...
df_final6.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/AvgPreci_4.csv")
...
# cargamos los datos
dfMax = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Tmax8.csv")
dfMin = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Tmin8.csv")
dfPre = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/Preci8.csv")
dfAmp = spark.read.option("header", "true").option("sep",";").schema(schema).csv(i + "/AmpT8.csv")
...
df_res = spark.createDataFrame(rdd_final1).toDF("Año","Avg_Temp") # reconvertimos a df
df_res = df_res.sort("Año")
df_res.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tavg8.csv") # guardamos en csv
...
df_res1 = df_res1.sort("Año")
df_res1.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/CambTemp8.csv") # guardamos en csv
...
df_res2 = spark.createDataFrame(rdd_res2).toDF("Año", "Desviacion_tipica") # reconvertimos a df
df_res2 = df_res2.sort("Año")
df_res2.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Desv8_results.csv") # guardamos en csv
...
df_res3.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tmax8_result.csv") # guardamos en csv
...
df_res4.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/Tmin8_results.csv") # guardamos en csv
...
result = dfAmp3.rdd.map(amplitude)
dfResult = spark.createDataFrame(result, ["Año", "Maxima Amplitud"])
dfResult.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/AmpTerm8.csv") # guardamos en csv
...
df_fin.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/DiasLluvia8.csv") # guardamos en csv
...
avg_preci = df_day.rdd.map(avg_preci_year).reduceByKey(lambda a,b: ("basura", (a[1]+b[1]), (a[2]+b[2]))).map(lambda x: (x[0], x[1][1]/x[1][2]))
df_final6 = spark.createDataFrame(avg_preci).toDF("Año","Avg_Preci")
df_final6.write.mode("overwrite").option("header", "true").option("sep",";").csv(o + "/AvgPreci_8.csv")




print(time() - t_0, "seconds elapsed in the execution ----------------------------------------------------------------------")