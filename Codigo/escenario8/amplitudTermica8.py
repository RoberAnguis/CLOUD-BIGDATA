...
df = spark.read.option("header", "true").option("sep",";").schema(schema).csv("AmpT8.csv")
...
dfResult.write.mode("overwrite").option("header", "true").option("sep",";").csv("AmpTerm8.csv") # guardamos en csv
