...
df = spark.read.option("header", "true").option("sep",";").schema(schema).csv("Preci8.csv") #para RCP 8.5, usar "Preci8.csv"
...
df_final.write.mode("overwrite").option("header", "true").option("sep",";").csv("AvgPreci_8.csv")
