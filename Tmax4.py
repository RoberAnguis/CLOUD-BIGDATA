...
t_max_4_max = df3.rdd.map(max_month) 
df_res = spark.createDataFrame(t_max_4_max).toDF("Año","Temp_Max") # reconvertimos a df
df_res.write.mode("overwrite").option("header", "true").option("sep",";").csv("Tmax4_result.csv") # guardamos en csv
